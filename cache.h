...
/*
 * refresh_index() *never* updates skip_worktree entries, but it does match them
 * against the given pathspecs, mark the matches on seen[], check if unmerged,
 * etc. With this flag, skip_worktree entries are ignored entirely.
 */
